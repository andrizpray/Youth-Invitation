    ...
    <div style={{ fontFamily: '"Cormorant Garamond", "Playfair Display", serif', color: colors.accent, backgroundColor: colors.secondary }}>
      ...
      >
        ...
        <div className="relative z-10">
          <p className="text-white/60 text-xs uppercase tracking-[0.4em] mb-8">~ Undangan Pernikahan ~</p>

          <div className="mb-4">
            <p className="text-white/50 text-sm mb-1">Bismillahirrahmanirrahim</p>
          </div>
          ...
          <p className="text-white/60 text-sm max-w-xs mx-auto leading-relaxed mb-10">
        ...
        <div className="absolute bottom-8 animate-bounce text-white/30 text-xl">↓</div>
      </section>
          ...
          <div className="flex flex-col gap-8 max-w-xs">
            {invitation.parent_name && (
              <div className="p-6 rounded-2xl" style={{ backgroundColor: colors.primary + '18', border: `1px solid ${colors.primary}33` }}>
                ...
                <p className="text-xs opacity-50">Putra dari</p>
                <p className="text-sm opacity-70 mt-1">{invitation.parent_name}</p>
              </div>
            )}
            {invitation.parent_name2 && (
              <div className="p-6 rounded-2xl" style={{ backgroundColor: colors.primary + '18', border: `1px solid ${colors.primary}33` }}>
                ...
                <p className="text-xs opacity-50">Putri dari</p>
                <p className="text-sm opacity-70 mt-1">{invitation.parent_name2}</p>
              </div>
            )}
          </div>
        </section>
      ...
      {(invitation.date_akad || invitation.time_akad) && (
        <section className={sectionClass} style={{ backgroundColor: colors.primary + '15' }}>
          <p className="text-xs uppercase tracking-[0.3em] opacity-40 mb-6">Akad Nikah</p>
      ...
      {(invitation.date_resepsi || invitation.time_resepsi) && (
        <section className={sectionClass} style={{ backgroundColor: colors.secondary }}>
          <p className="text-xs uppercase tracking-[0.3em] opacity-40 mb-6">Resepsi Pernikahan</p>
          <div className="w-16 h-px mx-auto mb-8" style={{ backgroundColor: colors.primary }} />
          <p className="text-3xl font-bold mb-3" style={{ color: colors.accent }}>
      ...
      {invitation.location && (
        <section className={sectionClass} style={{ backgroundColor: colors.primary + '15' }}>
          <p className="text-xs uppercase tracking-[0.3em] opacity-40 mb-6">Lokasi</p>
          <div className="w-16 h-px mx-auto mb-8" style={{ backgroundColor: colors.primary }} />
      ...
      {invitation.story && (
        <section className={sectionClass} style={{ backgroundColor: colors.secondary }}>
          <p className="text-xs uppercase tracking-[0.3em] opacity-40 mb-6">Kisah Kami</p>
          <div className="w-16 h-px mx-auto mb-8" style={{ backgroundColor: colors.primary }} />
      ...
      {photos.length > 0 && (
        <section className="py-20 px-6" style={{ backgroundColor: colors.primary + '15' }}>
          <p className="text-xs uppercase tracking-[0.3em] opacity-40 text-center mb-6">Galeri</p>
          <div className="w-16 h-px mx-auto mb-8" style={{ backgroundColor: colors.primary }} />
      ...
      {/* RSVP */}
      <section className={sectionClass} style={{ backgroundColor: colors.secondary }}>
        <p className="text-xs uppercase tracking-[0.3em] opacity-40 mb-6">Konfirmasi Kehadiran</p>
        <div className="w-16 h-px mx-auto mb-8" style={{ backgroundColor: colors.primary }} />
        <RsvpSection
          guests={guests}
      ...
      >
        <p className="text-white/40 text-xs uppercase tracking-widest mb-6">~ Dengan Cinta ~</p>
