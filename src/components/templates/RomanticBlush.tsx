            ...
            <div className="flex flex-col gap-8 max-w-xs mx-auto">
              {invitation.parent_name && (
                <div
                  ...
                  style={{ backgroundColor: colors.primary + '18', border: `1px solid ${colors.primary}33`, boxShadow: `0 4px 24px ${colors.primary}18` }}
                >
      ...
      {(invitation.date_resepsi || invitation.time_resepsi) && (
        <section className={sectionClass} style={{ backgroundColor: colors.secondary }}>
          <ScrollReveal className="w-full">
            ...
            <div
              className="max-w-xs mx-auto p-8 rounded-2xl"
              style={{ backgroundColor: colors.primary + '10', border: `1px solid ${colors.primary}33`, boxShadow: `0 8px 32px ${colors.primary}18` }}
            >
              <p className="text-3xl font-bold mb-3" style={{ color: colors.accent }}>
      ...
      {invitation.location && (
        <section className={sectionClass} style={{ backgroundColor: colors.primary + '15' }}>
          <ScrollReveal className="w-full">
            ...
            {invitation.address && (
              <p className="text-sm opacity-85 max-w-xs mx-auto leading-relaxed mb-8">{invitation.address}</p>
            )}
            {invitation.maps_url && (
              <a
                ...
                className="inline-flex items-center gap-2 px-6 rounded-full text-sm font-medium transition-opacity hover:opacity-90 active:scale-95"
      ...
      {invitation.story && (
        <section className={sectionClass} style={{ backgroundColor: colors.secondary }}>
          <ScrollReveal className="w-full">
            ...
            <div className="w-16 h-px mx-auto mb-8" style={{ backgroundColor: colors.primary }} />
            <p className="text-sm opacity-90 max-w-sm mx-auto leading-relaxed italic">"{invitation.story}"</p>
          </ScrollReveal>
        </section>
      )}
            ...
            <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
              {photos.map((url, i) => (
                <button
                  ...
                  className={`overflow-hidden rounded-2xl gallery-item cursor-zoom-in block ${i === 0 ? 'col-span-2 aspect-video' : 'aspect-square'}`}
