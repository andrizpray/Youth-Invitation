...
export default function InviloveStyle({ invitation, guests, onRsvpSubmit, rsvpStatus, rsvpError }: TemplateProps) {
  ...
  try { colors = JSON.parse(invitation.colors); } catch { colors = { primary: '#e88d9c', secondary: '#fef6f7', accent: '#8b3a4a' }; }
  let photos: string[];
  ...
  const STYLE_FONT_ESTHETIC = '"Parisienne", cursive';
  ...
  return (
    <div style={{ fontFamily: STYLE_FONT }}>
      ...
      <style jsx>{`
        ...
        .font-esthetic { font-family: 'Parisienne', cursive !important; }
